...
for count in range(0, motion_mask_count):
    for col in range( (motion_masks[count][0][0]-1)//16, (motion_masks[count][0][1]-1+15)//16 ):
        for row in range( (motion_masks[count][1][0]-1)//16, (motion_masks[count][1][1]-1+15)//16 ):
    ...
    try:
        while True:
            ...
            if motion_detected:
                ...
                print('FP', motion_filename, filepath)
